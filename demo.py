...
def main():
    ...
    while (True):
        ...
        # 画像レンダリング
        result_image, rightpoint, leftpoint = render(frame, keypoints_list, scores_list, bbox_list, rightpoint, leftpoint)
...
def render(image, keypoints_list, scores_list, bbox_list, rightpoint, leftpoint):
    render = image.copy()
